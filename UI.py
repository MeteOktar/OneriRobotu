...
class UI:
    def __init__(self):
        ...
        self.user_input_frame_1 = LabelFrame(
            self.frame, bg="lightpink", text="Input Area 1", bd=0, 
            highlightthickness=0, labelanchor="n", font=("Arial", 12, "bold")
        )
        self.user_input_frame_2 = LabelFrame(
            self.frame, bg="lightgreen", text="Input Area 2", bd=0, 
            highlightthickness=0, labelanchor="n", font=("Arial", 12, "bold")
        )
        self.user_input_frame_3 = LabelFrame(
            self.frame, bg="lightblue", text="Input Area 3", bd=0, 
            highlightthickness=0, labelanchor="n", font=("Arial", 12, "bold")
        )
        self.user_input_frame_4 = LabelFrame(
            self.frame, bg="lightgray", text="Input Area 4", bd=0, 
            highlightthickness=0, labelanchor="n", font=("Arial", 12, "bold")
        )
        ...
        self.submit_button.grid(row=4, column=0, sticky="news", padx=100, pady=10)
