...
user_input_frame_1 = LabelFrame(frame, 
                                bg="lightpink", 
                                text="Input Area 1", 
                                bd=0, 
                                ...
                                labelanchor="n", 
                                font=("Arial", 12, "bold"))
user_input_frame_2 = LabelFrame(frame, 
                                bg="lightgreen", 
                                text="Input Area 2", 
                                bd=0, 
                                highlightthickness=0, 
                                labelanchor="n", 
                                font=("Arial", 12, "bold"))
user_input_frame_3 = LabelFrame(frame, 
                                bg="lightblue", 
                                text="Input Area 3", 
                                bd=0, 
                                highlightthickness=0, 
                                labelanchor="n", 
                                font=("Arial", 12, "bold"))
user_input_frame_4 = LabelFrame(frame, 
                                bg="lightgray", 
                                text="Input Area 4", 
                                bd=0, 
                                highlightthickness=0, 
...
first_user_input = Label(user_input_frame_1, 
                         text="First Input", 
                         bg="lightpink", 
                         font=("Arial", 12, "bold"))
second_user_input = Label(user_input_frame_2, 
                          text="Second Input", 
                          bg="lightgreen", 
                          font=("Arial", 12, "bold"))
third_user_input = Label(user_input_frame_3, 
                         text="Third Input", 
                         bg="lightblue", 
                         font=("Arial", 12, "bold"))
fourth_user_input = Label(user_input_frame_4, 
                          text="Fourth Input", 
                          bg="lightgray", 
                          font=("Arial", 12, "bold"))
...
rating_1 = Label(user_input_frame_1, 
                 text="Rating-1", 
                 bg="lightpink", 
                 font=("Arial", 12, "bold"))
rating_2 = Label(user_input_frame_2, 
                 text="Rating-2", 
                 bg="lightgreen", 
                 font=("Arial", 12, "bold"))
rating_3 = Label(user_input_frame_3, 
                 text="Rating-3", 
                 bg="lightblue", 
                 font=("Arial", 12, "bold"))
rating_4 = Label(user_input_frame_4, 
                 text="Rating-4", 
                 bg="lightgray", 
                 font=("Arial", 12, "bold"))
